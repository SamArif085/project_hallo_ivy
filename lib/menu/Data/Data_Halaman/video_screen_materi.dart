...
class VideoScreenMateri extends StatefulWidget {
  const VideoScreenMateri({
    Key? key,
  ...
  _VideoScreenMateriState createState() => _VideoScreenMateriState();
}

class _VideoScreenMateriState extends State<VideoScreenMateri>
